...
import 'package:medical_appointment/presentation/signup_screen/models/signup_model.dart';
import 'package:medical_appointment/data/models/registerDeviceAuth/post_register_device_auth_resp.dart';
import 'package:medical_appointment/data/models/registerDeviceAuth/post_register_device_auth_req.dart';
import 'dart:async';
import 'package:medical_appointment/data/repository/repository.dart';
...
class SignupBloc extends Bloc<SignupEvent, SignupState> {
  ...
  FutureOr<void> _callRegisterDeviceAuth(
    ...
    var postRegisterDeviceAuthReq = PostRegisterDeviceAuthReq(
      username: state.fullNameController?.text ?? '',
      password: state.passwordController1?.text ?? '',
