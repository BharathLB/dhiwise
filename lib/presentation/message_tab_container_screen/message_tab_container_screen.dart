...
import 'package:medical_appointment/presentation/message_page/message_page.dart';
...
import 'package:medical_appointment/widgets/app_bar/appbar_title.dart';
import 'package:medical_appointment/widgets/app_bar/custom_app_bar.dart';
import 'package:medical_appointment/widgets/custom_bottom_bar.dart';
import 'package:medical_appointment/widgets/custom_floating_button.dart';
...
class MessageTabContainerScreenState extends State<MessageTabContainerScreen>
  ...
  Widget build(BuildContext context) {
    ...
    return BlocBuilder<MessageTabContainerBloc, MessageTabContainerState>(
      builder: (context, state) {
        return SafeArea(
          child: Scaffold(
            appBar: _buildScheduleAppBar(context),
            body: SizedBox(
  ...
  /// Section Widget
  PreferredSizeWidget _buildScheduleAppBar(BuildContext context) {
    return CustomAppBar(
      height: 50.v,
      title: AppbarTitle(
